...
def main(argv=None) -> int:
    ...
    if args.latex:
        ...
        out.write_text("\n".join([
            ...
            r"all-reduce bandwidth was "
            f"{nv:.0f}\\,GiB/s within one host, {s24:.2f}\\,GiB/s across two hosts "
            f"at eight devices, and {s28:.2f}\\,GiB/s at sixteen devices. "
            ...
            r"arm & $d$ & $N$ & \texttt{1x8} & measured & model & measured & original "
            r"& corrected \\",
            r"\midrule",
            *body,
