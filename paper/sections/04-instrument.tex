...
The library uses JAX and compiler-driven sharding \citep{jax2018,gspmd2021}. It generates
...
to $6.3\times10^{-6}$ relative error in the norm of the whole parameter tree. Floating-point and compilation differences can
...
wider fitness scores even when model evaluation uses bfloat16. On a synthetic block,
